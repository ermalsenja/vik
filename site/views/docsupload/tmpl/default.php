...
<div class="vrc-docsupload-container">
	<h4><?php echo JText::_('VRC_UPLOAD_DOCUMENTS'); ?></h4>
	<?php
	...
	<div class="info vrc-docsupload-disclaimer"><?php echo JText::_('VRC_PRECHECKIN_DISCLAIMER'); ?></div>
	...
	<form action="<?php echo JRoute::_('index.php?option=com_vikrentcar'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post">
		...
		<div class="vrc-docsupload-wrap">
				...
				<div class="vrc-docsupload-fields-inner">
					<div class="vrc-docsupload-field vrc-docsupload-field-upload">
						...
						<div class="vrc-docsupload-upload-container">
							<button type="button" class="btn vrc-pref-color-btn-secondary vrc-docsupload-uploadfile"><?php VikRentCarIcons::e('camera'); ?> <?php echo JText::_('VRC_ADD'); ?></button>
					...
					<div class="vrc-docsupload-field vrc-docsupload-field-comments">
						<span class="vrc-docsupload-field-key"><?php echo JText::_('VRADDNOTES'); ?></span>
						<span class="vrc-docsupload-field-input">
							<textarea id="vrc-docsupload-comments" name="docsupload[comments]"><?php echo JHtml::_('esc_textarea', $docs_uploaded->get('comments', '')); ?></textarea>
						</span>
					</div>
				</div>
			</div>
			<div class="vrc-docsupload-order">
				<div class="vrc-docsupload-order-details">
					...
					<div class="vrc-order-details-info-inner">
						<span class="vrc-order-details-info-key"><?php echo JText::_('VRPICKUP'); ?></span> 
						<span class="vrc-order-details-info-val"><?php echo $wdays_map[$info_from['wday']] . ' ' . date($df . ' ' . $nowtf, $this->order['ritiro']); ?></span>
					</div>
					<div class="vrc-order-details-info-inner">
						<span class="vrc-order-details-info-key"><?php echo JText::_('VRRETURN'); ?></span> 
		...
		<div class="vrc-oconfirm-footer">
			...
			<div class="vrc-save-order-block vrc-docsupload-submit">
				<input type="submit" name="docsuploadsubmit" value="<?php echo JText::_('VRPROSEGUI'); ?>" class="btn vrc-pref-color-btn"/>
			</div>
		</div>
