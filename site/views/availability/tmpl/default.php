		...
		<div class="vrc-availability-car-details">
			...
			<div class="vrc-availability-car-details-last vrcselectc">
				<div class="vrc-availability-car-details-last-inner">
					<a class="btn vrc-pref-color-btn" id="vrc-av-btn-<?php echo $car['id']; ?>" href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$car['id'].'&pickup=-1'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VRBOOKNOW'); ?></a>
				</div>
