	...
	<fieldset class="adminform">
		<div class="vrc-params-wrap">
			...
			<div class="vrc-params-container">
				...
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::_('VRCCONFDEPCUSTCHOICE'); ?></div>
					<div class="vrc-param-setting"><?php echo $vrc_app->printYesNoButtons('depcustchoice', JText::_('VRYES'), JText::_('VRNO'), (VikRentCar::depositCustomerChoice() ? 1 : 0), 1, 0); ?></div>
				</div>
				<div class="vrc-param-container">
