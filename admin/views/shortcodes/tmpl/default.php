			...
			<tr class="row">
				...
				<td style="text-align: center;">
					...
					<?php } else { ?>
						...
						<a href="index.php?option=com_vikrentcar&task=shortcode.add_to_page&cid[]=<?php echo $row->id; ?>&return=<?php echo $this->returnLink; ?>" class="btn btn-danger vrc-link-btn-small" onclick="return confirm('<?php echo $this->escape(JText::_('VRC_SC_ADDTOPAGE_HELP')); ?>');">
