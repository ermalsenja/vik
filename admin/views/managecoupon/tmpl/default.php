						...
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting">
								<div class="input-append">
									<input type="number" step="any" min="0" name="mintotord" value="<?php echo $row ? $row['mintotord'] : '0'; ?>"/>
									<button type="button" class="btn"><?php echo $currencysymb; ?></button>
								</div>
							</div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::_('VRC_MAX_BOOK_TOTAL'); ?></div>
							<div class="vrc-param-setting">
								<div class="input-append">
									<input type="number" step="any" min="0" name="maxtotord" value="<?php echo $row ? $row['maxtotord'] : '0'; ?>"/>
									<button type="button" class="btn"><?php echo $currencysymb; ?></button>
								</div>
							</div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo $vrc_app->createPopover(array('title' => JText::_('VRCCOUPONEXCLTAX'), 'content' => JText::_('VRCCOUPONEXCLTAXHELP'))); ?> <?php echo JText::_('VRCCOUPONEXCLTAX'); ?></div>
							<div class="vrc-param-setting">
								<?php echo $vrc_app->printYesNoButtons('excludetaxes', JText::_('VRYES'), JText::_('VRNO'), (($row && $row['excludetaxes'] == 1) || !$row ? 1 : 0), 1, 0); ?>
							</div>
						</div>
					</div>
				</div>
