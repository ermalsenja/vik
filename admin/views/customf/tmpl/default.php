...
<div class="table-responsive">
	...
	for ($i = 0, $n = count($rows); $i < $n; $i++) {
		...
		<tr class="row<?php echo $k; ?>">
			...
			<td class="vrc-highlighted-td"><a href="index.php?option=com_vikrentcar&amp;task=editcustomf&amp;cid[]=<?php echo (int)$row['id']; ?>"><?php echo JHtml::_('esc_html', JText::_($row['name'])); ?></a></td>
