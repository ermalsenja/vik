	...
	<div class="table-responsive">
		...
		for ($i = 0, $n = count($rows); $i < $n; $i++) {
			...
			<tr class="row<?php echo $k; ?>">
				...
				<td class="vrc-highlighted-td"><a href="index.php?option=com_vikrentcar&amp;task=editoptional&amp;cid[]=<?php echo (int)$row['id']; ?>"><?php echo JHtml::_('esc_html', $row['name']); ?></a></td>
				<td class="vrc-wrap-table-description"><?php echo (strlen($row['descr']) > 150 ? substr(strip_tags($row['descr']), 0, 150) : strip_tags($row['descr'])); ?></td>
