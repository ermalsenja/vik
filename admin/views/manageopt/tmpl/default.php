				...
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						...
						<div class="vrc-param-container">
							...
							<div class="vrc-param-setting"><?php echo $currencysymb; ?> <input type="number" step="any" name="maxprice" value="<?php echo count($row) && !is_null($row['maxprice']) ? (float)$row['maxprice'] : ''; ?>"/></div>
						</div>
						<div class="vrc-param-container">
						...
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::_('VRC_MIN_DAYS_RENT'); ?></div>
							<div class="vrc-param-setting">
								<input type="number" min="0" name="forceifdays" value="<?php echo count($row) ? (int)$row['forceifdays'] : ''; ?>"/>
								<span class="vrc-param-setting-comment"><?php echo JText::_('VRC_OPT_MINMAXDAYS_FILTER_HELP'); ?></span>
							</div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::_('VRC_MAX_DAYS_RENT'); ?></div>
							<div class="vrc-param-setting">
								<input type="number" min="0" name="maxdays" value="<?php echo count($row) ? (int)$row['maxdays'] : ''; ?>"/>
								<span class="vrc-param-setting-comment"><?php echo JText::_('VRC_OPT_MINMAXDAYS_FILTER_HELP'); ?></span>
							</div>
						</div>
						<div class="vrc-param-container">
